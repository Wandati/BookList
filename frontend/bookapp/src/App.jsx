...
function App() {
  ...
  const fetchBooks = async () => {
    ...
    try {
      const response = await axios.get(
        "https://booklist-tp5r.onrender.com/api/books/"
      );
  ...
  const handleDelete = async (id) => {
    ...
    if (window.confirm("Are you sure you want to delete this book?")) {
      try {
        await axios.delete(
          `https://booklist-tp5r.onrender.com/api/books/${book_id}/`
        );
    ...
    <div className="container">
      ...
      {loading ? (
        <div className="text-center">
          <p className="mt-4">Fetching Data...Might Take a while due to render's spin down with inactivity, which can delay requests by 50 seconds or more. </p>
        </div>
      ) : (
        <>
          <div className="mb-3">
